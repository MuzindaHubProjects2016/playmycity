...
artistBio += '<ul><li><span class="span-label-bio">Artist:</span><span id="bio-name"></span></li>';
artistBio += '<li id="bio-rank"><span class="span-label-bio hidden-data">Rank:</span></li>';
artistBio += '<li><span class="span-label-bio">Genre:</span><span id="bio-genre"></span></li>';
artistBio += '<li><span class="span-label-bio">City:</span><span id="bio-city"></span></li>';
artistBio += '<li><span class="span-label-bio">Requests:</span><span id="bio-requests"></span></li>';
artistBio += '<li><a href="#"><span class="span-label-bio">Confirmed:</span><span id="bio-confirmed"></span></a></li></ul>';
artistBio += '</div>';
